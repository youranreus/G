<?php $this -> need('header.php'); ?>
 ...
 <div id="article">
   <div id="article-content">
     <h1><?php $this -> archiveTitle(array('category' => _t('分类「%s」下的文章'), 'search' => _t('包含关键字「%s」的文章'), 'tag' => _t('标签 「%s」 下的文章'), 'author' => _t('「%s」 发布的文章')), '', ''); ?></h1>
  <?php while($this->next()): ?>
     <div id="article-<?php $this->cid();?>" class="article-item">
       ...
       <div id="article-<?php $this->cid();?>-preview"><?php $this->excerpt(80); ?></div>
     </div>
 <?php endwhile; ?>
