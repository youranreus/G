...
<head>
	...
	<link rel="stylesheet" href="<?php $this->options->themeUrl('CSS/G.css'); ?>?v=2.4.28" rel="stylesheet" />
	...
	<link href="<?php $this->options->themeUrl('CSS/dark.css'); ?>?v=2.4.2.4" rel="<?php if($_COOKIE['night'] != '1'){echo 'alternate ';} ?>stylesheet" type="text/css" title="dark">
