...
<?php elseif($this->options->IndexStyle == 2): ?>
  ...
  <?php while($this->next()): ?>
    <div class="card-item">
       <article>
         <div class="card-cover" style="background-image: url(<?php  $imgurl = $this->fields->imgurl;if($imgurl != ''){echo $imgurl;}else{if($this->options->enableFirstIMG == 1 && getPostImg($this)){echo getPostImg($this);}else{$this->options->defaultPostIMG();}}?>)"></div>
