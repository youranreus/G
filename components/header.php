...
<head>
    ...
    <link rel="stylesheet" href="<?php echo G::staticUrl('static/css/toc.min.css'); ?>?v=3.227">
    <link rel="stylesheet" href="<?php echo G::staticUrl('static/css/G.css'); ?>?v=3.231">
    <link rel="stylesheet <?php if (!isset($_COOKIE['night']) || $_COOKIE['night'] != '1') {echo 'alternate';} ?>" href="<?php echo G::staticUrl('static/css/dark.css'); ?>?v=3.226" title="dark">
