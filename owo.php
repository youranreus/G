...
<div class="OwO OwO-open" id="qaq">
   <div class="OwO-body" id="OwO-body">
    <ul id="OwO-pp" class="OwO-items OwO-items-emoticon OwO-items-show" style="max-height: 197px;">
      ...
      <li class="OwO-item" onclick="Smilies.grin('@(chaiquan_love)');"><img src="<?php $this->options->themeUrl('IMG/bq/'); ?>chaiquan_love.png" /></li>
     ...
     <li class="OwO-item" onclick="Smilies.grin('@(haha)');"><img src="<?php $this->options->themeUrl('IMG/bq/'); ?>yo.png" /></li>
     ...
     <li class="OwO-item" onclick="Smilies.grin('@(yo)');"><img src="<?php $this->options->themeUrl('IMG/bq/'); ?>yo.png" /></li>
